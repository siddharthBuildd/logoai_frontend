  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transition-smooth",
  {
    variants: {
      variant: {
        ...
        hero: "glass glass-hover rounded-xl text-white font-semibold shadow-lg hover:shadow-xl relative overflow-hidden",
        "hero-primary": "glass glass-hover rounded-xl text-white font-semibold shadow-lg hover:shadow-xl relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500",
        "service-blue": "glass-blue glass-hover rounded-xl text-white font-medium shadow-lg",
        "service-purple": "glass-purple glass-hover rounded-xl text-white font-medium shadow-lg",
        "service-green": "glass-green glass-hover rounded-xl text-white font-medium shadow-lg",
      },
      size: {
